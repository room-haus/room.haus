...
import CaseTexture from '../../images/mx031.jpg';
...
const sceneColors = [
  new BABYLON.Color4(23 / 255, 35 / 255, 34 / 255, 1),
  new BABYLON.Color4(189 / 255, 186 / 255, 93 / 255, 1),
  new BABYLON.Color4(113 / 255, 109 / 255, 100 / 255, 1),
];
...
export const build = ({scene, audio}) => {
  ...
  const myShape = [
    ...
    new BABYLON.Vector3(0.6, 0.75, 0),
    new BABYLON.Vector3(0.15, 1, 0),
  ];

  const shapeA = BABYLON.Mesh.CreateBox('box', 0.5, scene, true);
  const shapeB = BABYLON.MeshBuilder.CreateLathe('star', {shape: myShape, updatable: true}, scene);
...
export class Background extends React.Component {
  ...
  componentDidMount() {
    ...
    const manifestUrl = 'https://roomhauscdnprd.blob.core.windows.net/assets/MX031/video/highway.m3u8';
