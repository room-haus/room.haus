...
export class Background extends React.Component {
  ...
  componentDidMount() {
    ...
    const manifestUrl = `https://roomhauscdnprd.blob.core.windows.net/assets/MX019BGV/MX019BGV.m3u8`;
  ...
  render() {
    return (
      <Container>
        <Video key="video" innerRef={this.videoRef} autoPlay={true} type="video/mp4" loop muted playsinline />
      </Container>
    );
  }
}
