...
import CaseTexture from '../../images/mix-art/mx032.jpg';
import CDLabelTexture from '../../images/mix-labels/cd_template_MX032.png';
...
const sceneColors = [
  new BABYLON.Color4(51 / 255, 6 / 255, 39 / 255, 1),
  new BABYLON.Color4(234 / 255, 59 / 255, 155 / 255, 1),
];
...
export const build = ({scene, audio}) => {
  ...
  const shapeA = BABYLON.Mesh.CreateSphere('sphere', 3, 1, scene, true);
  const shapeB = BABYLON.MeshBuilder.ExtrudeShape(
    'star',
    {shape: myShape, path: myPath, sideOrientation: BABYLON.Mesh.DOUBLESIDE, updatable: true},
    scene,
  );

  makeParticles(scene, shapeA, 100);
  makeParticles(scene, shapeB, 100);
  shapeA.dispose();
  shapeB.dispose();
...
export class Background extends React.Component {
  ...
  componentDidMount() {
    ...
    const manifestUrl = 'https://roomhauscdnprd.blob.core.windows.net/assets/MX032/video/machines.m3u8';
